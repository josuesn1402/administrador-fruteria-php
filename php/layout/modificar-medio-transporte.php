...
if (isset($_GET['id'])) {
  ...
  $sqlTransporte = "SELECT * FROM medio_transporte WHERE medio_id = ?";
...
<section class="p-8">
  <div class="container mx-auto">
    ...
    <form id="transporteForm" method="POST" action="../controllers/medioTransporteCtrl/modificarCtrl.php" class="grid gap-6">
      <input type="hidden" id="id" name="id" value="<?php echo $transporte['medio_id']; ?>" required>
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col">
          ...
          <input type="text" id="capacidad" name="capacidad" value="<?php echo $transporte['capacidad']; ?>" class="p-2 border rounded-lg">
        </div>
      </div>
